 ...
 * The divisibility rule of 9 says that a number is divisible by 9
 * if the sum of its digits is also divisible by 9.
 * Therefore, if a number is divisible by 9, then, recursively,
 * all the digit sums are also divisible by 9.
