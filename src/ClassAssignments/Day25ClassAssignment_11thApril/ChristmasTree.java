...
public class ChristmasTree {
    ...
    private static int solve(int A[],int B[]){
        ...
        /**
         * The idea is to fix j and then find i which is less then j and k which is greator then j
         * at every iteration find the corresponding B[i] and B[k]
         * if the addition ans is minimum then store in the ans;
         * */
